...
[Релизы на GitHub](https://github.com/But3rflys/umbrella-work/releases?q=umbrella-lua&expanded=true)
<!-- releases:end -->
...
- `scripts/luatool.exe`: разбор Lua 5.4 и все операции скилла.
  ...
  - `check`: проверка синтаксиса, локализации, меню и вызовов API.
  - `check --log`: ошибки скрипта из `debug.log`.
